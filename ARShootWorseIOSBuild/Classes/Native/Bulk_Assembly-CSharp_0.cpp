...
extern "C" IL2CPP_METHOD_ATTR void enemyScript_Update_m9F358F7DD3045B8543AFFECA24D8DBBA6BD28AFA (enemyScript_t636DE381AB2B5D67203626EAB8D3EB46C8F8281B * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  L_2 = Vector3_op_Multiply_m1C5F07723615156ACF035D88A1280A9E8F35A04E(L_1, (3.0f), /*hidden argument*/NULL);
...
extern "C" IL2CPP_METHOD_ATTR void webCamScript_Update_m1D2008C4BDF7D57ACD864BF2E2AA95E8BFD143A9 (webCamScript_t0C2DF66F29A43B7B86D267B7401C1B85B3A22AFF * __this, const RuntimeMethod* method)
{
	...
	memset(&V_4, 0, sizeof(V_4));
	{
		...
		if (((int32_t)((int32_t)L_0%(int32_t)((int32_t)100))))
		{
			goto IL_006c;
		}
	}
	{
		Gyroscope_t004CBC5FD2FC2B3E27EE405E16FBB27ACC9BB2DC * L_1 = Input_get_gyro_m02AF58177532ADEB59E4D85C87D9CE9AE58A5610(/*hidden argument*/NULL);
		NullCheck(L_1);
		Quaternion_t319F3319A7D43FFA5D819AD6C0A98851F0095357  L_2 = Gyroscope_get_attitude_m18FE33B6830A3521DF01DAE47D93D3277196EEE8(L_1, /*hidden argument*/NULL);
		V_1 = L_2;
		float L_3 = (&V_1)->get_x_0();
		Gyroscope_t004CBC5FD2FC2B3E27EE405E16FBB27ACC9BB2DC * L_4 = Input_get_gyro_m02AF58177532ADEB59E4D85C87D9CE9AE58A5610(/*hidden argument*/NULL);
		NullCheck(L_4);
		Quaternion_t319F3319A7D43FFA5D819AD6C0A98851F0095357  L_5 = Gyroscope_get_attitude_m18FE33B6830A3521DF01DAE47D93D3277196EEE8(L_4, /*hidden argument*/NULL);
		V_2 = L_5;
		float L_6 = (&V_2)->get_y_1();
		Gyroscope_t004CBC5FD2FC2B3E27EE405E16FBB27ACC9BB2DC * L_7 = Input_get_gyro_m02AF58177532ADEB59E4D85C87D9CE9AE58A5610(/*hidden argument*/NULL);
		NullCheck(L_7);
		Quaternion_t319F3319A7D43FFA5D819AD6C0A98851F0095357  L_8 = Gyroscope_get_attitude_m18FE33B6830A3521DF01DAE47D93D3277196EEE8(L_7, /*hidden argument*/NULL);
		V_3 = L_8;
		float L_9 = (&V_3)->get_z_2();
		Gyroscope_t004CBC5FD2FC2B3E27EE405E16FBB27ACC9BB2DC * L_10 = Input_get_gyro_m02AF58177532ADEB59E4D85C87D9CE9AE58A5610(/*hidden argument*/NULL);
		NullCheck(L_10);
		Quaternion_t319F3319A7D43FFA5D819AD6C0A98851F0095357  L_11 = Gyroscope_get_attitude_m18FE33B6830A3521DF01DAE47D93D3277196EEE8(L_10, /*hidden argument*/NULL);
		V_4 = L_11;
		float L_12 = (&V_4)->get_w_3();
		Quaternion__ctor_m7502F0C38E04C6DE24C965D1CAF278DDD02B9D61((Quaternion_t319F3319A7D43FFA5D819AD6C0A98851F0095357 *)(&V_0), L_3, L_6, ((-L_9)), ((-L_12)), /*hidden argument*/NULL);
...
IL_006c:
	{
		int32_t L_15 = __this->get_count_6();
		__this->set_count_6(((int32_t)il2cpp_codegen_add((int32_t)L_15, (int32_t)1)));
		return;
	}
}
#ifdef __clang__
